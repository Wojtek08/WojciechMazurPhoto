...
<body>
    ...
    <main>
        ...
        <section class="subpages-gallery">
            <img src="../../assets/01.06.2023 Trzy korony/Dobre (12 of 12).jpg" alt="Panorama Trzech Koron">
            <h3 class="warning">Loading High Resolution Image...</h3>
            <div class="images-container">
                <a href="2.php"><img src="../../assets/01.06.2023 Trzy korony/1.jpg" alt="Trzy Korony 1"></a>
