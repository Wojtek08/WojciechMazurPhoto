...
<body>
    ...
    <main>
        ...
        <section class="subpages-gallery">
            <img src="../../assets/01.06.2023 Trzy korony/3.jpg" alt="Trzy Korony 3">
            <div class="images-container">
                <a href="1.php"><img src="../../assets/01.06.2023 Trzy korony/Dobre (12 of 12).jpg" alt="Trzy Korony 2"></a>
                <a href="2.php"><img src="../../assets/01.06.2023 Trzy korony/2.jpg" alt="Trzy Korony 3"></a>
                <a href="4.php"><img src="../../assets/01.06.2023 Trzy korony/3.jpg" alt="Panorama Trzech Koron"></a>
            </div>
        </section>
    </main>
    <footer>
