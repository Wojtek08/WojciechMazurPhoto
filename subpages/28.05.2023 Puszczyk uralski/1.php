...
<body>
    ...
    <main>
        ...
        <section class="subpages-gallery">
            <img src="../../assets/28.05.2023 Puszczyk uralski/1.jpg" alt="Young Strix uralensis 1">
            <div class="images-container">
                <a href="2.php"><img src="../../assets/28.05.2023 Puszczyk uralski/2.jpg" alt="Young Strix uralensis 2"></a>
            </div>
        </section>
    </main>
    <footer>
